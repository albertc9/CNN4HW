set moduleName sigmoid_array_array_ap_fixed_20_10_5_3_0_1u_sigmoid_config8_s
set isTopModule 0
...
set C_modelName {sigmoid<array,array<ap_fixed<20,10,5,3,0>,1u>,sigmoid_config8>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer7_out int 24 regular {fifo 0 volatile }  }
	{ layer8_out int 32 regular {axi_s 1 volatile  { layer8_out Data } }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "layer8_out", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer7_out_dout sc_in sc_lv 24 signal 0 } 
	...
	{ layer8_out_TDATA sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer7_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "layer7_out", "role": "dout" }} , 
 	...
 	{ "name": "layer8_out_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer8_out", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "sigmoid_array_array_ap_fixed_20_10_5_3_0_1u_sigmoid_config8_s",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_layer8_out_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	sigmoid_array_array_ap_fixed_20_10_5_3_0_1u_sigmoid_config8_s {
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_data_in 0 24 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 }  { layer7_out_empty_n fifo_status 0 1 }  { layer7_out_read fifo_port_we 1 1 } } }
	layer8_out { axis {  { layer8_out_TDATA out_data 1 32 }  { layer8_out_TVALID out_vld 1 1 }  { layer8_out_TREADY out_acc 0 1 } } }
}
