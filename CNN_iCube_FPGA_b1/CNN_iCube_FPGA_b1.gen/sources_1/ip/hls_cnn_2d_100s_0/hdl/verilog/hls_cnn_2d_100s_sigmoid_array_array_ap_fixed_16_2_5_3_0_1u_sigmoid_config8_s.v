...
module hls_cnn_2d_100s_sigmoid_array_array_ap_fixed_16_2_5_3_0_1u_sigmoid_config8_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [9:0] layer7_out_read_reg_171;
reg    ap_block_state1;
wire    ap_CS_fsm_state2;
wire   [63:0] zext_ln96_fu_153_p1;
wire   [11:0] data_round_fu_80_p3;
wire  signed [12:0] sext_ln90_fu_87_p1;
wire   [12:0] index_fu_91_p2;
wire   [2:0] tmp_1_fu_109_p4;
wire   [0:0] tmp_fu_101_p3;
wire   [0:0] xor_ln92_fu_125_p2;
wire   [0:0] icmp_ln94_fu_119_p2;
wire   [0:0] or_ln92_fu_139_p2;
wire   [9:0] select_ln92_fu_131_p3;
wire   [9:0] trunc_ln91_fu_97_p1;
wire   [9:0] index_1_fu_145_p3;
wire   [13:0] shl_ln_fu_158_p3;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (layer8_out_TREADY_int_regslice == 1'b1))) begin
...
assign data_round_fu_80_p3 = {{layer7_out_read_reg_171}, {2'd0}};

assign icmp_ln94_fu_119_p2 = ((tmp_1_fu_109_p4 != 3'd0) ? 1'b1 : 1'b0);

assign index_1_fu_145_p3 = ((or_ln92_fu_139_p2[0:0] == 1'b1) ? select_ln92_fu_131_p3 : trunc_ln91_fu_97_p1);

assign index_fu_91_p2 = ($signed(sext_ln90_fu_87_p1) + $signed(13'd512));

assign layer8_out_TDATA_int_regslice = shl_ln_fu_158_p3;

assign layer8_out_TVALID = regslice_both_layer8_out_U_vld_out;

assign or_ln92_fu_139_p2 = (tmp_fu_101_p3 | icmp_ln94_fu_119_p2);

assign select_ln92_fu_131_p3 = ((xor_ln92_fu_125_p2[0:0] == 1'b1) ? 10'd1023 : 10'd0);

assign sext_ln90_fu_87_p1 = $signed(data_round_fu_80_p3);

assign shl_ln_fu_158_p3 = {{sigmoid_table_q0}, {4'd0}};

assign sigmoid_table_address0 = zext_ln96_fu_153_p1;

assign tmp_1_fu_109_p4 = {{index_fu_91_p2[12:10]}};

assign tmp_fu_101_p3 = index_fu_91_p2[32'd12];

assign trunc_ln91_fu_97_p1 = index_fu_91_p2[9:0];

assign xor_ln92_fu_125_p2 = (tmp_fu_101_p3 ^ 1'd1);

assign zext_ln96_fu_153_p1 = index_1_fu_145_p3;

endmodule //hls_cnn_2d_100s_sigmoid_array_array_ap_fixed_16_2_5_3_0_1u_sigmoid_config8_s
