...
always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp35 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0_ignore_call4));
end
...
always @ (*) begin
    ap_block_pp0_stage1_11001_ignoreCallOp26 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage1_iter0_ignore_call4));
end
...
always @ (*) begin
    ap_block_state12_pp0_stage1_iter1 = (grp_compute_output_buffer_2d_array_array_ap_fixed_12_2_5_3_0_20u_config2_s_fu_146_layer2_out_blk_n == 1'b0);
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = ((input_1_TVALID_int_regslice == 1'b0) & (icmp_ln24_reg_280 == 1'd0));
end

always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_ignore_call4 = ((input_1_TVALID_int_regslice == 1'b0) & (icmp_ln24_reg_280 == 1'd0));
end
