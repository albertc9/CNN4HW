set moduleName relu_array_ap_fixed_10u_array_ap_fixed_16_2_5_3_0_10u_relu_config5_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,10u>,array<ap_fixed<16,2,5,3,0>,10u>,relu_config5>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer4_out int 120 regular {fifo 0 volatile }  }
	{ layer5_out int 160 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 120, "direction" : "READONLY"} , 
 	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 160, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer4_out_dout sc_in sc_lv 120 signal 0 } 
	...
	{ layer5_out_din sc_out sc_lv 160 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer4_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":120, "type": "signal", "bundle":{"name": "layer4_out", "role": "dout" }} , 
 	...
 	{ "name": "layer5_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":160, "type": "signal", "bundle":{"name": "layer5_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer4_out { ap_fifo {  { layer4_out_dout fifo_data_in 0 120 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer4_out_fifo_cap fifo_update 0 9 }  { layer4_out_empty_n fifo_status 0 1 }  { layer4_out_read fifo_port_we 1 1 } } }
	layer5_out { ap_fifo {  { layer5_out_din fifo_data_in 1 160 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer5_out_fifo_cap fifo_update 0 9 }  { layer5_out_full_n fifo_status 0 1 }  { layer5_out_write fifo_port_we 1 1 } } }
}
