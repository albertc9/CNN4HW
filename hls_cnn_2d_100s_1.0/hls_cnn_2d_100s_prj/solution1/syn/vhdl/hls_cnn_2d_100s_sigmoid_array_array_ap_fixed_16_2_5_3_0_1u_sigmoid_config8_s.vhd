...
entity hls_cnn_2d_100s_sigmoid_array_array_ap_fixed_16_2_5_3_0_1u_sigmoid_config8_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of hls_cnn_2d_100s_sigmoid_array_array_ap_fixed_16_2_5_3_0_1u_sigmoid_config8_s is 
...
attribute shreg_extract : string;
    ...
    signal layer7_out_read_reg_171 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal zext_ln96_fu_153_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal data_round_fu_80_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal sext_ln90_fu_87_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal index_fu_91_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_1_fu_109_p4 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_fu_101_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln92_fu_125_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln94_fu_119_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln92_fu_139_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln92_fu_131_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal trunc_ln91_fu_97_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal index_1_fu_145_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal shl_ln_fu_158_p3 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    component hls_cnn_2d_100s_sigmoid_array_array_ap_fixed_16_2_5_3_0_1u_sigmoid_config8_s_sigmoid_table_ROeOg IS
    generic (
        DataWidth : INTEGER;
...
begin
    sigmoid_table_U : component hls_cnn_2d_100s_sigmoid_array_array_ap_fixed_16_2_5_3_0_1u_sigmoid_config8_s_sigmoid_table_ROeOg
    generic map (
        DataWidth => 10,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    regslice_both_layer8_out_U : component hls_cnn_2d_100s_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                layer7_out_read_reg_171 <= layer7_out_dout;
            end if;
        end if;
    end process;
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (layer8_out_TREADY_int_regslice = ap_const_logic_1))) then
    ...
    data_round_fu_80_p3 <= (layer7_out_read_reg_171 & ap_const_lv2_0);
    icmp_ln94_fu_119_p2 <= "0" when (tmp_1_fu_109_p4 = ap_const_lv3_0) else "1";
    index_1_fu_145_p3 <= 
        select_ln92_fu_131_p3 when (or_ln92_fu_139_p2(0) = '1') else 
        trunc_ln91_fu_97_p1;
    index_fu_91_p2 <= std_logic_vector(signed(sext_ln90_fu_87_p1) + signed(ap_const_lv13_200));
    ...
    layer8_out_TDATA_int_regslice <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_fu_158_p3),16));
    ...
    or_ln92_fu_139_p2 <= (tmp_fu_101_p3 or icmp_ln94_fu_119_p2);
    select_ln92_fu_131_p3 <= 
        ap_const_lv10_3FF when (xor_ln92_fu_125_p2(0) = '1') else 
        ap_const_lv10_0;
        sext_ln90_fu_87_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(data_round_fu_80_p3),13));

    shl_ln_fu_158_p3 <= (sigmoid_table_q0 & ap_const_lv4_0);
    sigmoid_table_address0 <= zext_ln96_fu_153_p1(10 - 1 downto 0);
    ...
    tmp_1_fu_109_p4 <= index_fu_91_p2(12 downto 10);
    tmp_fu_101_p3 <= index_fu_91_p2(12 downto 12);
    trunc_ln91_fu_97_p1 <= index_fu_91_p2(10 - 1 downto 0);
    xor_ln92_fu_125_p2 <= (tmp_fu_101_p3 xor ap_const_lv1_1);
    zext_ln96_fu_153_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(index_1_fu_145_p3),64));
end behav;
