...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_cnn_2d_100s.autotvin.dat"
	set constFileTvOut       "hls_cnn_2d_100s.autotvout.dat"
	set constFileHdlTvIn     "hls_cnn_2d_100s.autohdltvin.dat"
	set constFileHdlTvOut    "hls_cnn_2d_100s.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
