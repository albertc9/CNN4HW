...
if {[file isfile hls_cnn_2d_100s.autotvin.dat]} {
	file delete -force hls_cnn_2d_100s.autotvin.dat
}

if {[file isfile hls_cnn_2d_100s.autotvout.dat]} {
	file delete -force hls_cnn_2d_100s.autotvout.dat
}
