set moduleName sigmoid_array_array_ap_fixed_16_2_5_3_0_1u_sigmoid_config8_s
set isTopModule 0
...
set C_modelName {sigmoid<array,array<ap_fixed<16,2,5,3,0>,1u>,sigmoid_config8>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer7_out int 10 regular {fifo 0 volatile }  }
	{ layer8_out int 16 regular {axi_s 1 volatile  { layer8_out Data } }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer7_out_dout sc_in sc_lv 10 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer7_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "layer7_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_data_in 0 10 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 }  { layer7_out_empty_n fifo_status 0 1 }  { layer7_out_read fifo_port_we 1 1 } } }
